...
- Although EZ-Flash IV PSRAM is now enabled, allowing Super CD-ROM² and Arcade CD-ROM² support, it does not currently work when the emulator is launched from NOR flash. This prevents execution of compilations which are over 16MB-192KB for Super CD-ROM² (e.g. Akumajou Dracula X), or those over 14MB for Arcade CD-ROM² (probably most of them).
#### SMSAdvance
